...
| Name  | Description |
|---|---|
| **[M01: Authentication](a7#31-module-m01-authentication)**          | Web resources associated with user authentication, includes the following system features: login/logout, registration, credential recovery. | 
| **[M02: Individual Profile](a7#32-module-m02-individual-profile)**      | Web resources associated with the user's personal information, which includes the following system features: view profile, edit profile, profiles, read profile timeline  | 
| **[M03: Friends](a7#33-module-m03-friends)**                  | Web resources associated with friend management, which includes the following system features: add friend/remove friend, create friend group/add friend to group, check friend requests, create group of friends, add friends to group of friends | 
| **[M04: Content](a7#34-module-m04-content)**                    | Web resources associated with posts and comments, which includes the following system features: create/edit/delete post, create/edit/delete comment, search content, appraise posts/comments, create comment rules, report content | 
| **[M05: Messages](a7#35-module-m05-messages)**                     | Web resources associated with messages, which includes the following system features: send/receive message, read message history |
| **[M06: Notifications](a7#36-module-m06-notifications)**          | Web resources associated with notifications which includes the following system features: view notifications, open notifications|
| **[M07: Administration](a7#37-module-m07-administration)**          | Web resources associated with admin moderation, which includes the following system features: ban users, check reported content, Remove content, create annoucements|
| **[M08: Static Pages](a7#38-module-m08-static-pages)**          | Web resources associated with static pages|
...
| **Submit**       | [R102](a7#r102-login-action) |   |
| **Permissions**  | PUB |  |
...
|                   | +remember_me: boolean  | 	Remember me   |
| **Redirects**    | [R412](a7#r412-view-feed) | Success |
|                  | [R101](a7#r101-login-form) | Error |
| **Permissions** | PUB |  |
...
| **Method**       | POST |   |
| **Redirects**    | [R101](a7#r101-login-form) | Success |
| **Permissions** | USR |  | 
...
| **Submit**       | [R105](a7#r105-register-action) |   |
| **Permissions**  | PUB |  |
...
| **Redirects**    | [R411](a7#r411-view-hot-page) | Success |
|                   | [R104](a7#r104-register-form) | Error |
| **Permissions** | PUB |  |
...
| **UI**           | [N/A](#) |   |
| **Submit**       | [R107](a7#r107-password-recovery-action) |   |
| **Permissions**  | PUB |  |
...
| **Redirects**    | [R106](a7#r106-password-recovery-form) | Success |
|                   | [R106](a7#r106-password-recovery-form) | Error |
| **Permissions** | PUB |  |
...
|                  | ?message: string | Error message |
| **Submit**       | [R109](a7#r109-password-update-action) |   |
| **Permissions** | PUB |  |
...
| **Redirects**    | [R412](a7#r412-view-feed) | Success |
|                  | [R108](a7#r108-password-update-form) | Error |
| **Permissions** | PUB |  |
...
#### Endpoints of Individual Profile
  ...
  * [R202](a7#r202-edit-profile-api): Edit Profile API [`/api/user/info`]
  * [R203](a7#r203-edit-email-api): Edit email API [`/api/user/email`]
  * [R204](a7#r204-edit-password-api): Edit password API [`/api/user/password`]
  * [R205](a7#r205-delete-user-account-action): Delete User Account Action [`/user`]
...
| **AJAX Calls**   | [R202](a7#r201-view-profile), [R203](a7#r203-edit-email-api), [R204](a7#r204-edit-password-api), [R302](a7#r302-view-friend-request-list), [R303](a7#r303-send-friend-request-api), [R305](a7#r305-unfriend-user-api), [R404](a7#r404-edit-post-api), [R406](a7#r406-delete-post-api), [R408](a7#r408-add-appraisal-api), [R409](a7#r409-delete-appraisal-api), [R410](a7#r410-report-content-api)  |   |
...
|                   | ?banner: file | Banner  |
| **Response Body** |[JSON202](a7#json202-edit-profile-user)|
...
| **Method**       | DELETE |   |
| **Redirects**    | [R101](a7#r101-login-form) | Success |
|                  | [R201](a7#r201-view-profile) | Error. |
|                  | [R803](a7#r803-403-page) | Error. Forbidden request: You need to be logged in. |
| **Permissions**  | USR |  |
...
| **Method**       | GET |   |
| **Parameters**   | +id: integer | user primary key  |
| **AJAX Calls**   | [R305](a7#r305-unfriend-user-api), [R306](a7#r306-create-group-of-friends-api), [R307](a7#r307-add-friend-to-group-of-friends-api), [R308](a7#r308-remove-friend-from-group-of-friends-api), [R309](a7#r309-delete-group-of-friends-api), [R310](a7#r310-rename-group-of-friends-api) |   |
...
| **Method**       | GET |   |
| **AJAX Calls**   | [R304](a7#r304-respond-friend-request-api) |   |
...
* [R408](a7#r408-add-appraisal-api): Add Appraisal API [`/api/content/{id}/appraisal`]
* [R409](a7#r409-delete-appraisal-api): Delete Appraisal API [`/api/content/{id}/appraisal`]
* [R410](a7#r410-report-content-api): Report Content API [`/api/content/{id}/report`]
* [R411](a7#r411-view-hot-page): View Hot Page [`/hot`]
* [R412](a7#r412-view-feed): View Feed [`/feed`]
* [R413](a7#r413-view-search): View Search [`/search`]
* [R414](a7#r414-search-api): Search API [`/api/search`]
<!--
* [R415](a7#r415-hot-page-api): Hot Page API [`api/hot`]
* [R416](a7#r416-news-feed-api): News Feed API [`api/feed`]
* [R417](a7#r417-post-api): Post API [`api/post/{id}`]
* [R418](a7#r418-user-posts-api): User Posts API [`api/users/{id}`]
-->
...
| **AJAX Calls**   | [R403](a7#r403-add-comment-api), [R404](a7#r404-edit-post-api), [R405](a7#r404-edit-post-api), [R406](a7#r404-edit-post-api), [R407](a7#r407-delete-comment-action-api), [R408](a7#r407-delete-comment-action-api), [R409](a7#r409-delete-appraisal-api), [R410](a7#r410-report-content-api) |   |
...
| **Response Body** |[JSON402](a7#json402-addeditdelete-post-post)|
...
| **Response Body** |[JSON403](a7#json403-addeditdelete-comment-comment)|
...
| **Method**       | POST |   |
| **Parameters**  | +id: integer | content id  |
| **Response Body** |[JSON410](a7#json410-add-report-report)|
...
| **Method**       | GET |   |
| **AJAX Calls**   | [R402](a7#r402-add-post-api), [R404](a7#r404-edit-post-api), [R406](a7#r406-delete-post-api), [R408](a7#r408-add-appraisal-api), [R409](a7#r409-delete-appraisal-api), [R410](a7#r410-report-content-api) |   |
...
| **AJAX Calls**   | [R404](a7#r404-edit-post-api), [R406](a7#r406-delete-post-api), [R408](a7#r408-add-appraisal-api), [R409](a7#r409-delete-appraisal-api), [R410](a7#r410-report-content-api), [R413](a7#r413-search-api) |
| **UI**           | [UI09](#)|   |
| **Permissions**  | PUB |  |
...
| **Response Body** |[JSON414](a7#json414-search-postsusers-postuser)|
...
#### Endpoints of Messages
  ...
  * [R501](a7#r501-messages-page): Messages Page [`/messages`]
  * [R502](a7#r502-general-message-history-api): General Message History API [`/api/messages/`]
  * [R503](a7#r503-user-message-history-api): User Message History API [`/api/messages/{id}`]
  * [R504](a7#r504-send-message-api): Send Message API [`/api/messages/{id}`]
  * [R505](a7#r505-delete-message-api): Delete Message API [`/api/messages/{id}`]
  * [R506](a7#r506-see-conversation-api): See Conversation API [`/api/messages/{id}/seen`]
...
| **Method**       | GET |   |
| **AJAX Calls**   | [R502](a7#r502-general-message-history-api), [R503](a7#r503-user-message-history-api), [R504](a7#r504-send-message-api), [R505](a7#r505-delete-message-api)|   |
...
| **Method**       | GET |
| **Response Body** | [JSON501](a7#json501-messages-page-latest_message) |
...
| **Response Body** | [JSON502](a7#json502-general-message-history-message) |  |
...
| **Response Body** | [JSON504](a7#json504-senddelete-message-message) |  |
 ...
 * [R601](a7#r601-set-notification-as-seen-api): Set Notification as Seen API [`/api/notifications/{id}`]
...
#### Endpoints of Administration
  ...
  * [R703](a7#r703-add-announcement-api): Add Announcement API [`/api/admin/announcements`] 
  * [R704](a7#r704-delete-announcement-api): Delete Announcement API [`/api/admin/announcements/{id}`]
  * [R705](a7#r705-view-reported-posts-page): View Reported Posts Page [`/admin/reports`] 
  * [R706](a7#r706-clear-post-reports-api): Clear post reports API [`/api/admin/reports/{id}`] 
  * [R707](a7#r707-view-users-page): View Users Page [`/admin/users`] 
  * [R708](a7#r708-ban-user-api): Ban User API [`/api/users/{id}/ban`]
  * [R709](a7#r709-unban-user-api): Unban User API [`/api/users/{id}/unban`] 
...
| **Method**       | GET |   |
| **UI**           | [N/A](#)|   |
| **Redirects**    | [R702](a7#r702-view-announcement-page) | |
| **Permissions**  | ADM |  |
...
| **AJAX Calls**   | [R703](a7#r703-add-announcement-api), [R704](a7#r704-delete-announcement-api) |   |
...
| **Response Body** |[JSON703](a7#json703-adddelete-announcement-announcement)|
...
| **Method**       | GET |   |
| **Parameters** | ?offset: integer | Page number (for pagination)  |
| **AJAX Calls**   | [R406](a7#r406-delete-post-api), [R407](a7#r407-delete-comment-action-api), [R706](a7#r706-clear-post-reports-api), [R708](a7#r708-ban-user-api) |   |
| **UI**           | [UI03](a3#ui03-admin)|   |
| **Permissions**  | ADM |  |
...
| **AJAX Calls**   | [R708](a7#r708-ban-user-api), [R709](#r709-unban-user-api) |   |
| **UI**           | [UI03](a3#ui03-admin)|   |
| **Permissions**  | ADM |  |
...
* [R803](a7#r803-403-page): 403 Page [`/403`] 
* [R804](a7#r804-404-page): 404 Page [`/404`] 
...
| **Method**       | GET |   |
| **UI**           | [N/A](#)|   |
| **Redirects**    | [R411](a7#r411-view-feed) | In case the user is logged in, redirect to news feed  |
|                  | [R101](a7#r101-login-form)| If the user is not authenticated, redirect to login form  |
| **Permissions**  | PUB |  |
